...
import Code from '@assets/image/code-brackets.svg'
...
import Flow from '@assets/image/flow.svg'
import Plugin from '@assets/image/plugin.svg'
import Repo from '@assets/image/repo.svg'
import StackAlt from '@assets/image/stackalt.svg'
